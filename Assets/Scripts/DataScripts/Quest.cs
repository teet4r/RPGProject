...
public class Quest : ScriptableObject
{
    ...
    [SerializeField] QuestMonster[] questRequireMonster; // 퀘스트 완료 조건 몬스터
    ...
    [SerializeField] SerializableDictionary<Npc, int> requireQuests; // 퀘스트 발동 조건 숫자
    ...
    public SerializableDictionary<Npc, int> RequireQuests { get { return requireQuests; } }
    ...
    public class QuestMonster
    {
        ...
        public MonsterData Monster { get { return monster; } }
